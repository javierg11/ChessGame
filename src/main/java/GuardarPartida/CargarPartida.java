...
public class CargarPartida implements Runnable{
	...
	public CargarPartida(JFrame tablero, JButton[][] casillas, JButton casilla,
	...
	private JPanel crearPanelGuardar() {
	    ...
	    botonCargar.addActionListener(e -> {
	        ...
	        String[] nombres = partidas.stream()
	        ...
	        if (seleccion != null) {
	            Partida partidaSeleccionada = partidas.stream()
	...
	private void actualizarTableroHasta(int hasta) {
	    // Aplica movimientos hasta el índice indicado (sin incluir el movimiento en 'hasta')
