...
import Inicio.InicioSesion.JERoundPasswordField;
import Inicio.InicioSesion.JERoundTextField;

public class JugarConAmigos {
    ...
    public static void JButtonsConfiracion() {
     ...
     // Acción del botón principal (solo muestra un mensaje de demostración)
        actionButton.addActionListener(e -> {
            ...
            String contrasena = new String(passText.getPassword());
